...
async def update_customer(
    ...
    created_customer = CUSTOMERS_STORAGE[customer_id]
    
    if updated_customer.name:
        created_customer.name = updated_customer.name

    if updated_customer.surname:
        created_customer.surname = updated_customer.surname
...
async def create_customer(customer: CustomerCreateSchema) -> Customer:
    ...
    created_customer = Customer(**customer.dict(), id=id)
    CUSTOMERS_STORAGE[id] = created_customer
